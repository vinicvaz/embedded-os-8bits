...
{
    clothes_control_t clothes_waiting[5];
    u_int fila_size;
    clothes_control_t clothes_washing;
    clothes_control_t clothes_ironing;
    clothes_control_t clothes_finished[5];
...
void task_read_buttons()
{
   while (1)
   {
      ...
      if (PORTDbits.RD0 == 1 && f_clothes.fila_size < 5)
      {
      ...
      else if (PORTDbits.RD1 == 1 && f_clothes.fila_size < 5)
      {
...
void check_wash()
{
   while (1)
   {
      ...
      if (flag_wash == 0 && f_clothes.fila_size > 0)
      {
