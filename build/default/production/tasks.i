...
{
    clothes_control_t clothes_waiting[8];
    u_int fila_size;
    clothes_control_t clothes_washing;
    clothes_control_t clothes_ironing;
    clothes_control_t clothes_finished[8];
...
void task_read_buttons()
{
   while (1)
   {
      ...
      if (PORTDbits.RD0 == 1 && f_clothes.fila_size < 8 && flag == 0)
      {
      ...
      else if (PORTDbits.RD1 == 1 && f_clothes.fila_size < 8 && flag == 0)
      {
...
void run_wash()
{
   ...
   if (w_machine.counter >= 10000 && f_clothes.clothes_washing.washing_cycles == 1)
