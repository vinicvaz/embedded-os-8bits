...
{
    clothes_control_t clothes_waiting[3];
    u_int fila_size;
    clothes_control_t clothes_washing;
    clothes_control_t clothes_ironing;
    clothes_control_t clothes_finished[3];
...
void task_read_buttons() {
   ...
   if (PORTDbits.RD0 == 1 && f_clothes.fila_size < 3) {
   ...
   } else if (PORTDbits.RD1 == 1 && f_clothes.fila_size < 3) {
